...
open class CarInfoAPI: APIBase {
    /**
     Find car by plate  , country  (ES)
     - parameter token: (query) Your token, use your real token or request a free token for fee here https://auto-ways.net/demo  
     - parameter plaque: (query) car plate  
     - parameter outputLang: (query) Define the API output language (fr,en) (optional, default to fr)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCarByPlateEs(token: String, plaque: String, outputLang: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCarByPlateFr(token: String, plaque: String, outputLang: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCarByPlateIt(token: String, plaque: String, outputLang: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCarByPlatePt(token: String, plaque: String, outputLang: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     Find car by VIN
     - parameter token: (query) Your token, use your real token or request a free token for fee here https://auto-ways.net/demo  
     - parameter vin: (query)  Your VIN (Vehicle Identification Number) 
     - parameter outputLang: (query) Define the API output language (fr,en) (optional, default to fr)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCarByVIN(token: String, vin: String, outputLang: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
