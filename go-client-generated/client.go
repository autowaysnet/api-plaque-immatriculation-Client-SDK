...
// APIClient manages communication with the API Car plate - API Plaque immatriculation API v1.0.0-oas3
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.CarInfoApi = (*CarInfoApiService)(&c.common)
